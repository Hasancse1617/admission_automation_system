                    ...
                    <table id="table" class="table table-bordered table-striped">
                        ...
                        @foreach($scholarships as $index => $scholarship)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm" href="{{ route('scholarship.single', ['id' => $scholarship->id]) }}">View</a>
                                    @php
                                        $apply = \App\Models\ScholarshipApply::where('student_id', Auth::user()->id)->first();
                                    @endphp
                                    @if($apply)
                                        ...
                                        @endif
                                    @else
                                        <a class="btn btn-info btn-sm" href="{{ route('scholarship.apply', ['id' => $scholarship->id]) }}">Apply</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
