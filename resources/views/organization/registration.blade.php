...
<head>
    ...
    <title>Organization Registration | {{ config('app.name') }}</title>
...
{{--            </a>--}}
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('organization_registration') }}" method="post">
                @csrf
                ...
                <div class="input-group mb-3">
                    <input type="password" autocomplete="current-password" name="password_confirmation" class="form-control" placeholder="Confirm Password">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            {{-- <span class="fas fa-lock"></span> --}}
                        </div>
